...
Ein möglicher Ansatz zur Bewältigung dieses Problems wurde kürzlich von Sandro Speth in Form von \textit{multi-project coding issues} (Multiprojekt-Kodierungsprobleme) und \textit{traceability links} (Nachverfolgungsverküpfungen), zusammen mit seiner grafische Notation für diese, vorgestellt. \\
...
Darüber hinaus sind erweiterte Funktionen wie das Öffnen des relevanten Softwareartefakten im Editor der IDE nicht möglich. \\
