...
Based on these aspects the \gls{Eclipse} \gls{IDE} was chosen.
It is one of the more popular \glspl{IDE} for \gls{java} \cite{geer2005eclipse}, 
...
Finally, I already had experiences with developing \gls{Eclipse} plugins.
