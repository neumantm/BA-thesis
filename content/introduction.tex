...
The objective of this thesis is to develop, implement, and evaluate a concept for integrating this approach into the developer's \gls{IDE}.
...
\begin{description}
	\item[Chapter~\ref{chap:ch2} -- \nameref{chap:ch2}:] In this chapter, the thesis' foundations of and related work are presented.
	...
	\item[Chapter~\ref{chap:ch5} -- \nameref{chap:ch5}:] The evaluation including the expert review and survey is described and discussed.
	\item[Chapter~\ref{chap:ch6} -- \nameref{chap:ch6}:] In this chapter, the final conclusion of the thesis is presented.
\end{description}